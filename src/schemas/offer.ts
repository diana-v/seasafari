...
export async function fetchOfferSectionData(offerId: string | string[], locale = 'lt', defaultLocale = 'lt'): Promise<OfferSectionResponse> {
    cacheTag('offer', typeof offerId === 'string' ? offerId : 'detail');
    cacheLife('weeks');
